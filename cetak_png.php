...
$bulan = isset($_GET['bulan'])?$_GET['kelas']:"";
...
if($kelas != ""&& $bulan != ""&& $kelas !=""){
    ...
    $sql = mysqli_query($conn, "select a.nama_siswa, b.nama_kelas from tbsiswa a, tbkelas b, tbsetkelas cwhere a.id=c. idsiswa AND b.idkelas=c.idkelas AND b.idkelas=$kelas order by a.nama_siswa ASC");
                                        ...
                                        case 8:
                                            ...
                                            case 9:
                                                ...
                                                case 10:
                                                    ...
                                                    <table border="1" cellpacing=0 cellpading=0 width="100%">
                                                        <tr>
                                                            <th width="2%">No</th>
                                                            <th>Nama Siswa</th>
                                                            <?=$header?>
